@extends('layouts.template', ['title' => 'Blog Page'])
                ...
                <div id="posts" class=" px-3 lg:px-7 py-6">
                    <div class="flex justify-between items-center border-b border-gray-100">
                        <div id="filter-selector" class="flex items-center space-x-4 font-light ">
                            <a class="text-gray-500 py-4 {{ request('order') != 'asc' ? '!text-gray-900 py-4 border-b border-gray-700' : '' }}" href="{{ route('blog', ['order' => 'desc'])}}">Latest</a>
                            <a class="text-gray-500 py-4 {{ request('order') == 'asc' ? '!text-gray-900 py-4 border-b border-gray-700' : '' }}" href="{{ route('blog', ['order' => 'asc'])}}">Oldest</a>
                        </div>
                    </div>
                    @if ($posts->count())
                        <div class="py-4">
